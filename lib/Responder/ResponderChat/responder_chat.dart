...
class RespondeerChatScreen extends StatefulWidget {
  final String recipientId, senderId;

  const RespondeerChatScreen({super.key, required this.recipientId, required this.senderId});

  @override
  _RespondeerChatScreenState createState() => _RespondeerChatScreenState();
}

class _RespondeerChatScreenState extends State<RespondeerChatScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      ...
      chatProvider.listenToMessages(userA:widget.recipientId, userB:widget.senderId);
    });
  }
...
void dispose() {
  ...
  Future<void> _sendMessage(BuildContext context) async {
    ...
    if (_controller.text.trim().isEmpty || authProvider.currentUserProfile?.id == null) return;
    ...
    return Scaffold(
      ...
      body: Consumer<ProfileProvider>(
        builder: (context, profil, _) {
          var user = profil.currentUserProfile;
          return Column(
            children: [
                    ...
                    return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return BubbleSpecialThree(
                              ...
                              textStyle: TextStyle(
                                color: message['senderId'] == user?.id ? Colors.white : Colors.white,
                                fontSize: 15
                              ),
                            );
                          },
