...
import 'package:resq_track/Views/Auth/SignUp/signup_emergency.dart';
...
class CreatePasswordPage extends StatefulWidget {
  ...
  const CreatePasswordPage({super.key, required this.userRequest});
  @override
                      ...
                      if (getPasswordStrength() == 1.0) {
                        if (passwordTextController.text ==
                            confirmpasswordController.text) {
                              widget.userRequest.password = passwordTextController.text;
                          AppNavigationHelper.navigateToWidget(
                              context, SignUpEmergency(userRequest: widget.userRequest,));
                        }else{
                          NotificationUtils.showToast(context, message: "Password Mis-match");
                        }
                      } 
